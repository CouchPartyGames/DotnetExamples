...
// Step 1 - Add Identity UI Services
...
// Step 2 - Inject Email Provider Service
builder.Services.AddTransient<IEmailSender, EmailSendProviderService>();
...
public sealed class EmailSendProviderService : IEmailSender
{
